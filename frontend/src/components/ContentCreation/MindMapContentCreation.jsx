...
export default function MindMapContentCreation({ lesson, course, onComplete, onNext, onPrev, isFirstStep, isLastStep }) {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/upload/mindmap`, {
        method: 'POST',
        body: formData
      });
      ...
      if (response.ok) {
        ...
        setUploadedFile({
          ...
          size: file.size,
          type: file.type,
          path: `/uploads/lesson-${lesson.id}/mindmaps/${file.name}`,
  ...
  const handleComplete = () => {
    const content = {
      ...
      data: {
        file: uploadedFile,
        mindmap_url: uploadedFile?.path || null
      },
      completed: true
    };
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Upload a mind map image (.png, .jpg, .jpeg, .gif, .webp) for your lesson.
        </p>
      </div>
      ...
      <div style={styles.contentArea}>
        ...
        >
          <MapIcon style={styles.uploadIcon} />
          <div style={styles.uploadText}>Click to upload mind map image</div>
          <div style={styles.uploadSubtext}>Supports .png, .jpg, .jpeg, .gif, .webp files</div>
        </div>
        ...
        {uploadedFile && (
          <div style={styles.generatedContent}>
            <div style={styles.contentTitle}>Uploaded Mind Map:</div>
